...
logo_filepath = "Vertical_Full_Color_RGB.png"

# Configure site title, icon, and other
site_title = "BadgerBotGPT"
site_icon = ":nerd_face:"

# Set the page title, description, and other text
page_title = "BadgerBotGPT for Professor Tillet's 301 Students"
description = "301 AI Teaching Assistant for Professor Tillet's Spring 2024 students: Always-On Assistance! Dive into intermediate financial accounting with your GPT4-powered helper. Ask questions about the course, study effectively, and conquer your exams. Go Badgers! 😎"
...
st.markdown(f"<h1 style='color: rgba(255, 0, 0, 1);'>{page_title}</h1>", unsafe_allow_html=True)
st.caption(description)
st.markdown(f"<h3 style='color: rgba(255, 0, 0, 1);'>Instructions</h3>", unsafe_allow_html=True)
...
st.sidebar.divider()
st.sidebar.markdown(f"<h3 style='color: rgba(255, 0, 0, 1);'>Tips and Tricks:</h3>", unsafe_allow_html=True)
st.sidebar.markdown(tips)
st.sidebar.divider()

feedback_text = "This app is a prototype and still a work-in-process. Please help improve it by sharing your feedback with Professor Tillet."
